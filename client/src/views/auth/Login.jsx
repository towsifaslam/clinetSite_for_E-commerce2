    ...
    <div className=' min-w-full min-h-screen bg-[#161d31] flex justify-center items-center'>
        <div className='w-[350px] text-[#d0d2d6]   p-2'>
            <div className='bg-[#283046] p-4 rounded-md'>
                ...
                <p className='text-sm mb-3'>Please login to your account and start you bussiness</p>
                <form  onSubmit={submit}>
                   ...
                   <button className='bg-blue-500 w-full hover:shadow-blue-500/50 hover:shadow-lg  text-white rounded-md px-7 py-2 mb-3' type='submit'>Sign in</button>
                   <div className='flex items-center mb-3 gap-3 justify-center'>
                    <p>Already have an account  <Link to='/register'>Signin here</Link></p>
                   </div>
