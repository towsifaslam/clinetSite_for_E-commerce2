              ...
              <table className="w-full text-sm text-left text-[#d0d2d6] ">
                <thead className="text-xs text-[#d0d2d6] uppercase border-b border-slate-700 ">
                  <tr>
                    ...
                    <th scope="col" className="py-3 px-4">
                      Devision
                    </th>     <th scope="col" className="py-3 px-4">
                      District
                    </th>
                    <th scope="col" className="py-3 px-4">
                      Action
                  ...
                  {[1, 2, 3, 4, 5, 6].map((v, i) => (
                    <tr key={i} className="text-sm font-normal">
                      ...
                      <td
                        ...
                        className="py-1 px-4 font-medium whitespace-nowrap"
                      >
                        <span>towsifaslamctg143@gamil.com</span>
                      </td>{" "}
                      <td
                        scope="row"
                        className="py-1 px-4 font-medium whitespace-nowrap"
                      ...
                      >
                        <div className="flex  justify-start items-center gap-4">
                          <Link to={`/admin/dashboard/sellers/details/:${i}`} className="p-[6px] bg-yellow-500 rounded hover:shadow-lg hover:shadow-yellow-500/50">
                            <FaEdit />{" "}
                          </Link>
